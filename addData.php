...
<head>
    ...
    <title>Tambah Data | SMKN XX</title>
</head>
            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control form-control-md w-50"" id="nis" placeholder="Masukkan NIS" min="1" name="nis" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
