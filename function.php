...
function tambah($data)
{
    ...
    $sql = "INSERT INTO siswa VALUES ('$nis','$nama','$tmpt_Lahir','$tgl_Lahir','$jekel','$kelas','$jurusan','$email','$gambar')";
...
function ubah($data)
{
    ...
    $sql = "UPDATE siswa SET nama = '$nama', tmpt_Lahir = '$tmpt_Lahir', tgl_Lahir = '$tgl_Lahir', jekel = '$jekel',  kelas = '$kelas', jurusan = '$jurusan', email = '$email', gambar = '$gambar' WHERE nis = $nis";
