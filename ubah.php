...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">DATA KESISWAAN | SMKN XX</a>
            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="nis" value="<?= $siswa['nis']; ?>" name="nis" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select w-50" id="kelas" name="kelas">
                            ...
                            <option value="X" <?php if ($siswa['kelas'] == 'X') { ?> selected='' <?php } ?>>X</option>
                            <option value="XI" <?php if ($siswa['kelas'] == 'XI') { ?> selected='' <?php } ?>>XI</option>
                            <option value="XII" <?php if ($siswa['kelas'] == 'XII') { ?> selected='' <?php } ?>>XII</option>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <img src="img/<?= $siswa['gambar']; ?>" width="20%" style="margin-bottom: 10px;">
  ...
  <div class="container p-4">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
        ...
        <p class="text-sm">
        Tumbuh dan berkembang menjadi lebih besar dan terbaik, merupakan tujuan warga sekolah SMK Negeri XX.
        Sejarah pengabdian SMK XX yang mulai didirikan pada tahun 1984 dan diresmikan penggunaannya pada tanggal
        2 Juli 1985 oleh Departemen Pendidikan dan Kebudayaan, berkat kerja sama antara Pemerintah, Industri dan 
        Masyarakat.
        </p>
      </div>
      <!--Grid column-->
      ...
      <div class="col-md-12 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="bi bi-house-door-fill"></i> <a href="#" target="_blank" style="text-decoration: none;" class="text-light">Alamat : Setiabudi, Jaksel</a></p>
          <p>
          <i class="bi bi-envelope-fill"></i><a href="mailto:dharmajiwork@gmail.com" class="text-decoration-none text-white"> Email : dharmajiwork@gmail.com </a>
          </p>
          <p><i class="bi bi-telephone-fill"></i> Telepon : 0823-1077-4281</p>
        </div>
    </div>
    <!--Grid row-->
  </div>
